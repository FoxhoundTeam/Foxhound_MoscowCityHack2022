...
const store = new Vuex.Store({
    ...
    actions: {
        async getCategories(context) {
            var response = await http.getList("Category", {}, true);
        ...
        async getGoods(context) {
            ...
            var response = await http.getList("Good", filters, true);
        ...
        async login(context, creds) {
            ...
            var status = false;
            try {
                var response = (await (Axios.post("/api/auth/sign-in/", login_info))).data;
        ...
        async checkAuth(context) {
            try {
                var result = await Axios.get("/api/auth/user/", { headers: http.getHeaders() });
